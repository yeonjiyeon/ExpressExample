...
CORS란 Cross Origin Resource Sharing의 약자로, 현재 도메인과 다른 도메인으로 리소스가 요청될
 경우를 말한다. 예를 들어, 도메인 http://A.com 에서 읽어온 HTML페이지에서 
 다른 도메인 http://B.com/image.jpg를 요청하는 경우를 말한다.
*/ 
...
var storage = multer.diskStorage({
    destination:function(req,file,callback){//destination:파일저장위치
        callback(null, 'uploads')
    },
    filename:function(req, file, callback){
        callback(null, file.originalname + Date.now())//중복방지
    }
});
